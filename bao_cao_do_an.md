...
usecaseDiagram
    ...
    usecase UC_ViewConcept as "Xem ý tưởng & Triết lý resort"
    usecase UC_ViewRooms as "Xem danh sách & Hạng phòng nghỉ"
    usecase UC_ViewDiningMenu as "Xem thực đơn chi tiết nhà hàng"
    usecase UC_ViewExperiences as "Xem danh sách hoạt động trải nghiệm"
    usecase UC_SearchRooms as "Tìm kiếm phòng trống (Bộ lọc khách)"
    usecase UC_BookRoom as "Thực hiện đặt phòng trực tuyến"
    usecase UC_ManageBookings as "Quản lý & Hủy phòng đã đặt"
